...
(function exposeRefsFactory(global) {
  ...
  function createRefs() {
    return {
      ...
      inviteLoginForm: document.getElementById("invite-login-form"),
      inviteLoginHint: document.getElementById("invite-login-hint"),
      inviteInfoBox: document.getElementById("invite-info-box"),
      inviteRegisterForm: document.getElementById("invite-register-form"),
      inviteArticleTitle: document.getElementById("invite-article-title"),
      inviteRoleBadge: document.getElementById("invite-role-badge"),
      inviteCreatedBy: document.getElementById("invite-created-by"),
      inviteRegisterUsername: document.getElementById(
        "invite-register-username",
      ),
      inviteRegisterPassword: document.getElementById(
        "invite-register-password",
      ),
      inviteRegisterDisplayName: document.getElementById(
        "invite-register-display-name",
      ),
      inviteRegisterTitle: document.getElementById("invite-register-title"),
      inviteRegisterDescription: document.getElementById(
        "invite-register-description",
      ),
      btnShowInviteRegister: document.getElementById(
        "btn-show-invite-register",
      ),
      btnShowInviteLogin: document.getElementById("btn-show-invite-login"),
      btnInviteRegister: document.getElementById("btn-invite-register"),
      ...
      appTopbar: document.getElementById("app-topbar"),
      ...
      accessDirectGrantSection: document.getElementById(
        "access-direct-grant-section",
      ),
      accessUserSearch: document.getElementById("access-user-search"),
      accessUserResults: document.getElementById("access-user-results"),
      accessSelectedUser: document.getElementById("access-selected-user"),
      accessArticleRole: document.getElementById("access-article-role"),
      btnGrantAccess: document.getElementById("btn-grant-access"),
      accessUserList: document.getElementById("access-user-list"),
      accessInviteSection: document.getElementById("access-invite-section"),
      accessInviteRole: document.getElementById("access-invite-role"),
      btnCreateInvite: document.getElementById("btn-create-invite"),
      accessInviteList: document.getElementById("access-invite-list"),
